 ...
 *    [dev.superdrop.protocol.server.InboundConnectionCompletion.connectionId]).
 *
...
public object ConsentIntents {
    ...
    public const val ACTION_ACCEPT: String = "dev.superdrop.consent.ACCEPT"

    /** Broadcast action fired when the user taps the notification's "Reject" action. */
    public const val ACTION_REJECT: String = "dev.superdrop.consent.REJECT"
     ...
     * [dev.superdrop.protocol.connection.InboundConnection.cancel]
     * rather than `submitUserConsent`.
     */
    public const val ACTION_CANCEL_TRANSFER: String = "dev.superdrop.consent.CANCEL_TRANSFER"
