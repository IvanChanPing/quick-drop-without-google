 ...
 *    the 6-hourly background [UpdateCheckWorker] does not re-notify for the
...
internal class UpdatePreferences(
     ...
     * notification for, or `null` if it never has. Used to de-duplicate the
     * "update available" alert across the 6-hourly polls.
     */
    ...
    /**
     * Whether the automatic 6-hourly GitHub update check runs. Defaults to
