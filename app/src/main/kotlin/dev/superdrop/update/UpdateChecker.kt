...
internal object UpdateChecker {
     ...
     *
     * This is what makes the update NOTIFICATION adaptive: when GitHub's CI
     * has built and attached the installable APK (release.yml uploads
     * `super-drop-<tag>.apk`), the notification can offer a direct
     * "Download & install" drop-in update; when no APK is present yet (a
     * tag exists but the build hasn't attached its artifact), the caller
     * falls back to only sending the user to the GitHub release page.
     */
