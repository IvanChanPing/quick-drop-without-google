...
import dev.superdrop.migration.LegacyPackageDetectorAndroid
import dev.superdrop.send.SendActivityInApp
...
internal class SendReceiveFragment : Fragment(R.layout.fragment_send_receive) {
     ...
     * [dev.superdrop.protocol.connection.FileSource] per
