...
import dev.superdrop.service.receiver.MdnsVisibilityOverrideHolder
...
/**
 * Quick Settings tile that opens the OShare **receive bottom sheet**
 * straight from the system Quick Settings panel (Phase 2), making the
...
internal class BadaQuickShareTileService : TileService() {
     ...
     * activity to show the "waiting for sender" panel; `EXTRA_TILE_ELEVATED`
     * flags that visibility was temporarily bumped for this sheet.
     *
    ...
    private fun launchReceiveSheet() {
        val intent =
            Intent(this, ConsentTrampolineActivity::class.java).apply {
                ...
                putExtra(ConsentIntents.EXTRA_TILE_ELEVATED, true)
