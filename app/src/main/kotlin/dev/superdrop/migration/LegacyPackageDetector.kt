 ...
 */
package dev.superdrop.migration
 ...
 * `dev.superdrop` makes the new install coresident with either previous
 ...
 *
 * The shape mirrors [dev.superdrop.battery.BatteryOptimizationOemHelper]:
 *
 ...
 * can also be referenced from [dev.superdrop.MainActivity] (the
