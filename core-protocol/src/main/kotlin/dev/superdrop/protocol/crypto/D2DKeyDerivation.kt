 ...
 */
package dev.superdrop.protocol.crypto
 ...
 *
 * ```
 * # Stage 1 — UKEY2 layer (inputs come from [dev.superdrop.protocol.ukey2.Ukey2HandshakeResult])
...
public object D2DKeyDerivation {
     ...
     *
     * The companion test [dev.superdrop.protocol.crypto.D2DKeyDerivationTest]
