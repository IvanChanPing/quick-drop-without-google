...
public object SecureMessageCodec {
     ...
     *   from [dev.superdrop.protocol.crypto.DirectionalKeys]).
     ...
     *   [dev.superdrop.protocol.transport.FramedConnection.sendFrame].
     ...
     *   [dev.superdrop.protocol.transport.FramedConnection.receiveFrame]).
     * @param decryptKey 32-byte AES-256 key (the local "receive" encrypt
     *   key from [dev.superdrop.protocol.crypto.DirectionalKeys]).
