 ...
 */
package dev.superdrop.protocol.sharing
 ...
 *    ([dev.superdrop.protocol.payload.PayloadTransferEncoder.encodeBytesPayload])
...
public sealed interface SharingFsmEffect {
     ...
     *     we; reuse causes the receiver's [dev.superdrop.protocol.payload.PayloadAssembler]
     *     to reject the frame).
     *  2. Calling [dev.superdrop.protocol.payload.PayloadTransferEncoder.encodeBytesPayload]
