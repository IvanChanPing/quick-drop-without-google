 ...
 * BYTES payload after [dev.superdrop.protocol.payload.PayloadAssembler]
 * reassembles it.
 *
 ...
 *    [dev.superdrop.protocol.payload.PayloadAssembler]
 *    surfaced.
...
public object SharingFrames {
     ...
     * [dev.superdrop.protocol.payload.PayloadEvent.BytesComplete].
