 ...
 * enters [dev.superdrop.protocol.sharing.InboundSharingState.WaitingForUserConsent].
 ...
 *   `authString` via [dev.superdrop.protocol.crypto.pin.PinDerivation.deriveFourDigitPin].
...
public data class TransferMetadata(
    ...
    public companion object {
         ...
         *   [dev.superdrop.protocol.sharing.SharingFsmEffect.IntroductionReceived].
