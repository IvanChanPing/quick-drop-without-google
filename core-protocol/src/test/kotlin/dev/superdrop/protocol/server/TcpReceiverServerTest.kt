 ...
 * deliberately do not pair against [dev.superdrop.protocol.connection.InboundConnection]
...
class TcpReceiverServerTest {
     ...
     * sender against it via [dev.superdrop.protocol.connection.OutboundConnection]
